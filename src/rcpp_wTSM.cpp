...
//
// Implemented by and adapted from:
// Dongdong Kong, Mingzhong Xiao, Yongqiang Zhang, Xihui Gu and Jianjian Cui (2020). phenofit:
// Extract Remote Sensing Vegetation Phenology. R package version 0.2.7.
